...
public class BillingControllerTests
{
    ...
    [Fact]
    public async Task ImportBillingAsync_ReturnsOkResult()
    {
        // Arrange
    ...
    public async Task CreateBillingAsync_ReturnsOkResult_WithBillingResponse()
    {
        ...
        var returnValue = Assert.IsType<BillingResponse>(okResult.Value);
    ...
    public async Task GetAllBillingsAsync_ReturnsOkResult_WithListOfBillingResponse()
    {
        ...
        // Assert
        var okResult = Assert.IsType<OkObjectResult>(result);
        var returnValue = Assert.IsAssignableFrom<IEnumerable<BillingResponse>>(okResult.Value);
    ...
    [Fact]
    public async Task DeleteBillingAsync_ReturnsOkResult()
    {
        // Arrange
        var billingId = Guid.NewGuid();
